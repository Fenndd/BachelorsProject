...
The baseline automation entry point is `orchestrator/cli/main.py`. It configures CMake, builds the baseline runner, adapter validator, and absolute-pose benchmark, then runs and parses them.
