...
def _fake_final_validation(**kwargs: Any) -> Path:
    ...
    _write_json(
        report_path,
        {
            ...
            "baseline": {"runs": [], "summary": {"successful_runs": 1, "failed_runs": 0, "median_runtime_ns_per_problem": 100.0, "all_correctness_passed": True}},
            "final": {"runs": [], "summary": {"successful_runs": 1, "failed_runs": 0, "median_runtime_ns_per_problem": 100.0, "all_correctness_passed": True}},
            "comparison": {
                "median_speedup": 1.0,
